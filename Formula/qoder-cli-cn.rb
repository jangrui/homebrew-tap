class QoderCliCn < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "970cc029160d3f422417ee6225a593ee2fbb709d752361b491127b50073d8e7a"
    end
    on_intel do
      url "https://static.qoder.com.cn/qoder-cli-cn/releases/#{version}/qoderclicn-darwin-x64.tar.gz"
      sha256 "0c9984526ea072f398297687d87a65dbb3822f4bac30a99dd41b089cfeaf7d3a"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "83cdb6c2d196f0d02846457ea12f0c808c533be5208a8579b8de2c364d2f481f"
    end
    on_intel do
      url "https://static.qoder.com.cn/qoder-cli-cn/releases/#{version}/qoderclicn-linux-x64.tar.gz"
      sha256 "c1f31b06b6e462a9c30e41f883e9e755aaf9dfd052dfa2624f2ebb01db729f74"
    end
  end
