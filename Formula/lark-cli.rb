class LarkCli < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "1c07f259de7201f3f7c88311bd63ec67cd2e9c5a3b1f7e497bf3c92f1a12b0f9"
    end
    on_intel do
      url "https://github.com/larksuite/cli/releases/download/v#{version}/lark-cli-#{version}-darwin-amd64.tar.gz"
      sha256 "8c9fe0478f3988d45ffc03ec72a09c2601e4ccf74b96505e00ea4d1cb7844250"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "b05ba05908dc711c3fb0f50cfd235072dfb04a3f23bb39d2f6e0ae2a496b8f16"
    end
    on_intel do
      url "https://github.com/larksuite/cli/releases/download/v#{version}/lark-cli-#{version}-linux-amd64.tar.gz"
      sha256 "78767460e6c8bb9811d9f28e8df7cd2721b14fdceb5b65ba42bf43e448c4bb78"
    end
  end
